...
//                                    HotelAlert.Append(1);
//                                    HotelAlert.Append(LanguageLocale.GetValue("console.noticefromadmin") +
//                                    Notice);
...
//                                        PiciEnvironment.messagingBot.SendMassMessage(new PublicMessage(string.Format("[{0}] => [{1}]", user.ircuser, Notice)), true);
...
//                            case "version":
//                                {
//                                    replies.Add(new PrivateMessage(PiciEnvironment.PrettyVersion));
//                                    break;
//                                }
...
//                                    replies.Add(new PrivateMessage("flush toilet                   - [/unused] Demonstration Rowposes Only"));
...
//                                    GameClient TargetClient = PiciEnvironment.GetGame().GetClientManager().GetClientByUsername(TargetUser);
...
//                            case "credits":
//                                {
//                                    GameClient TargetClient = PiciEnvironment.GetGame().GetClientManager().GetClientByUsername(parameters[1]);
//                                    if (TargetClient != null)
//                                    {
//                                        int creditsToAdd;
...
//                            case "stats":
//                                {
//                                    TimeSpan timeUsed = DateTime.Now - PiciEnvironment.ServerStarted;
//                                    replies.Add(new PrivateMessage("Users online: " + PiciEnvironment.GetGame().GetClientManager().ClientCount));
//                                    replies.Add(new PrivateMessage("Rooms loaded: " + PiciEnvironment.GetGame().GetClientManager().ClientCount));
//                                    replies.Add(new PrivateMessage("Server uptime: " + timeUsed.Days + " day(s), " + timeUsed.Hours + " hour(s) and " + timeUsed.Minutes + " minute(s)"));
//                                    replies.Add(new PrivateMessage("Server version string: " + PiciEnvironment.PrettyVersion));
//                                    break;
//                                }
//                            //case "staffonline":
//                            //    {
...
//                                        break;
//                                    }
//                                    PiciEnvironment.GetGame().GetBanManager().BanUser(TargetClient, user.ircuser + "@IRC", BanTime * 230400, MergeParams(parameters, 3), false);
...
//                                    Room TargetRoom = PiciEnvironment.GetGame().GetRoomManager().GetRoom(TargetClient.GetHabbo().CurrentRoomId);
...
//                                    PiciEnvironment.messagingBot.SendMassMessage(new PublicMessage(string.Format("[{0}] => [{1}] + [{2}]", user.ircuser, Link, Message)), true);
...
//                            case "powerlevels":
//                                {
//                                    replies.Add(new PrivateMessage("Powerlevel of our server is " + PiciEnvironment.GetRandomNumber(9001, 10000) + " (Over FUCKING 9000) GEE-ZUS!"));
//                                    break;
//                                }
...
//                                    replies.Add(new PrivateMessage(PiciEnvironment.PrettyVersion));
//                                    replies.Add(new PrivateMessage("Users online: " + PiciEnvironment.GetGame().GetClientManager().ClientCount));
//                                    replies.Add(new PrivateMessage("Rooms loaded: " + PiciEnvironment.GetGame().GetRoomManager().LoadedRoomsCount));
//                                    break;
//                                }
//                        }
...
//        {
//            return PiciEnvironment.GetGame();
//        }
//    }
//}