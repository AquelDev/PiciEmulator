...
namespace Pici.Messages.StaticMessageHandlers
{
    class StaticClientMessageHandler
    {
        ...
        /// </summary>
        public static Dictionary<string, short> InfoEvents;

        /// <summary>
        /// Storage of Invokers from Message Events
        /// </summary>
        public static Dictionary<short, Event> MessageEvents;

        internal static void StaticClient()
        {
            ...
            MessageEvents = new Dictionary<short, Event>();
            ...
            foreach (Type Type in Assembly.GetCallingAssembly().GetTypes())
            {
                ...
                if (Type.GetInterfaces().Contains(typeof(Event)))
                {
                    var ConstructorInfo = Type.GetConstructor(new Type[] { });

                    if (ConstructorInfo != null)
                    {
                        var Constructed = ConstructorInfo.Invoke(new object[] { }) as Event;
        ...
        internal static void HandlePacket(GameClientMessageHandler handler, ClientMessage message)
        {
            if (handlers.ContainsKey(message.Id))
            {
                ...
                //Event Event = MessageEvents[(short) message.Id];
        ...
        internal static void RegisterPacketLibary()
        {
            ...
            handlers.Add(100, new StaticRequestHandler(SharedPacketLib.HandleRowchase));
            handlers.Add(472, new StaticRequestHandler(SharedPacketLib.RowchaseGift));
            ...
            handlers.Add(3014, new StaticRequestHandler(SharedPacketLib.MarketplaceRowchase));
