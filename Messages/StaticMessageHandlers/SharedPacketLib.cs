...
namespace Pici.Messages.StaticMessageHandlers
{
    class SharedPacketLib
    {
        ...
        internal static void HandleRowchase(GameClientMessageHandler handler)
        {
            handler.HandleRowchase();
        }

        internal static void RowchaseGift(GameClientMessageHandler handler)
        {
            handler.RowchaseGift();
        }
        ...
        internal static void MarketplaceRowchase(GameClientMessageHandler handler)
        {
            handler.MarketplaceRowchase();
        }
