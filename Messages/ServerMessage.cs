...
namespace Pici.Messages
{
    internal class ServerMessage
    {
        ...
        internal string Header
        {
            get
            {
                return PiciEnvironment.GetDefaultEncoding().GetString(Base64Encoding.Encodeuint(MessageId, 2));
            }
        }
        ...
        //{
        //    return PiciEnvironment.GetDefaultEncoding().GetString(Body.ToArray());
        //}
