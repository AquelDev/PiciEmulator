...
namespace Pici.Net
{
    ...
    //{
        ...
        //    {
        //        FinalShutdown();
        //        PiciEnvironment.GetGame().GetClientManager().DisposeConnection(mID);
        //    }
        ...
        //{
        //    SendData(PiciEnvironment.GetDefaultEncoding().GetBytes(sData));
        //}
        ...
        //        PiciEnvironment.GetConnectionManager().CloseConnection(this.mID);
