...
using Pici.HabboHotel.Quests.Composer;
using Pici.Messages;
using Pici.Storage.Database.Session_Details.Interfaces;
using System;

namespace Pici.HabboHotel.Quests
{
    class QuestManager
    {
        ...
        //    PiciEnvironment.GetGame().GetQuestManager().HandleQuest(Id, Session);
        //}
        ...
        //    Message.Append(4); // explore, social, identity, room_builder() 4

        //    ParseNeed(Session, Message);

        //    Message.Append(1); // end line
