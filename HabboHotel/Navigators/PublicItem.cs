    ...
    internal class PublicItem
    {
        ...
        internal RoomData RoomData
        {
            get
            {
                ...
                if (PiciEnvironment.GetGame() == null)
                    throw new NullReferenceException();

                if (PiciEnvironment.GetGame().GetRoomManager() == null)
                    throw new NullReferenceException();

                if (PiciEnvironment.GetGame().GetRoomManager().GenerateRoomData(RoomId) == null)
                    throw new NullReferenceException();

                return PiciEnvironment.GetGame().GetRoomManager().GenerateRoomData(RoomId);
            }
        }
