...
namespace Pici.HabboHotel.Navigators
{
    class Navigator
    {
        ...
        internal ServerMessage SerializeFavoriteRooms(GameClient Session)
        {
            ...
            {
                room = PiciEnvironment.GetGame().GetRoomManager().GenerateRoomData(Id);
                if (room != null)
        ...
        internal ServerMessage SerializeRecentRooms(GameClient Session)
        {
            ...
            //            RoomData tData = PiciEnvironment.GetGame().GetRoomManager().FetchRoomData((uint)Row["id"], Row);
            //            tData.Fill(Row);
            ...
            //    }
                ...
                Rooms.AppendInt32(7);
                Rooms.AppendStringWithBreak("");
                //Rooms.Append(ValidRecentRooms.Count);
                Rooms.AppendInt32(0);
        ...
        internal ServerMessage SerializeEventListing(int Category)
        {
            ...
            KeyValuePair<RoomData, int>[] eventRooms = PiciEnvironment.GetGame().GetRoomManager().GetEventRoomsForCategory(Category);
        ...
        private ServerMessage SerializeActiveRooms(int category)
        {
            ...
            KeyValuePair<RoomData, int>[] rooms = PiciEnvironment.GetGame().GetRoomManager().GetRooms(category);
                ...
                case -2:
                    {
                        ...
                        KeyValuePair<RoomData, int>[] rooms = PiciEnvironment.GetGame().GetRoomManager().GetVotedRooms();
                        SerializeNavigatorRooms(ref reply, rooms);
                ...
                case -1:
                    {
                        ...
                        KeyValuePair<RoomData, int>[] rooms = PiciEnvironment.GetGame().GetRoomManager().GetActiveRooms();
