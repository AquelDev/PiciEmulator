...
namespace Pici.HabboHotel.Users.Messenger
{
    class HabboMessenger
    {
        ...
        {
            IEnumerable<GameClient> onlineUsers = PiciEnvironment.GetGame().GetClientManager().GetClientsById(friends.Keys);
...
8                =     Your friend is wanking*/
        ...
        {
            return PiciEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId);
        }
