...
namespace Pici.HabboHotel.Pets
{
    class Pet
    {
        internal uint PetId;
        ...
        internal Room Room
        {
            get
            {
                ...
                return PiciEnvironment.GetGame().GetRoomManager().GetRoom(RoomId);
            }
        }
        ...
        internal int Age
        {
            get
            {
                return (int)Math.Floor((PiciEnvironment.GetUnixTimestamp() - CreationStamp) / 86400);
            }
        }
        ...
        internal string OwnerName
        {
            get
            {
                return PiciEnvironment.GetGame().GetClientManager().GetNameById(OwnerId);
            }
        }
        ...
        */
        ...
        internal void PetEnergy(bool Add)
        {
            ...
            int r = PiciEnvironment.GetRandomNumber(4, MaxE);
