...
using System.Linq;
using Pici.HabboHotel.Achievements.Composer;
...
namespace Pici.HabboHotel.Achievements
{
    ...
    //        {
    //            Achievements.Add((uint)Row["id"], new Achievement((uint)Row["id"], (int)Row["levels"], (string)Row["badge"], (int)Row["pixels_base"], (double)Row["pixels_multiplier"], PiciEnvironment.EnumToBool(Row["dynamic_badgelevel"].ToString())));
    //        }
    //    }
    ...
    //        Message.Append(AchievementsToList.Count);
    ...
    //        Session.GetMessageHandler().GetResponse().Append(Achievement.Id);
    //        Session.GetMessageHandler().GetResponse().Append(Level);
    //        Session.GetMessageHandler().GetResponse().Append(FormatBadgeCode(Achievement.BadgeCode, Level, Achievement.DynamicBadgeLevel));

    //        if (Level > 1)
    //        {
    //            Session.GetMessageHandler().GetResponse().Append(FormatBadgeCode(Achievement.BadgeCode, (Level - 1), Achievement.DynamicBadgeLevel));
    //        }
    //        else
    //        {
    //            Session.GetMessageHandler().GetResponse().Append("");
    //        }
