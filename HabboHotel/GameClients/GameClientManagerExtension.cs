...
//                try
//                {
//                    PiciEnvironment.GetGame().GetBanManager().CheckForBanConflicts(Client);
//                }
...
//                    if (Client == null)
//                        continue;
//                    if (Client.GetHabbo() == null || !PiciEnvironment.GetGame().GetPixelManager().NeedsUpdate(Client))
//                        continue;

//                    PiciEnvironment.GetGame().GetPixelManager().GivePixels(Client);
//                }
//            }
