...
namespace Pici.HabboHotel.Rooms
{
    ...
    class RoomModel
    {
        ...
        internal int ClubOnly;
        internal bool gotPublicPool;

        internal RoomModel(int DoorX, int DoorY, double DoorZ, int DoorOrientation, string Heightmap, string StaticFurniMap, int ClubOnly, string Poolmap, List<PublicRoomSquare> Furnis)
        {
            try
            {
                this.DoorX = DoorX;
        ...
        //    Message.Append(HeightMap.ToString());
        //    return Message;
        //}
