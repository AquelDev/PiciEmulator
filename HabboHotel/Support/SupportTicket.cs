...
namespace Pici.HabboHotel.Support
{
    ...
    class SupportTicket
    {
        ...
        internal SupportTicket(UInt32 Id, int Score, int Type, UInt32 SenderId, UInt32 ReportedId, String Message, UInt32 RoomId, String RoomName, Double Timestamp)
        {
            ...
            this.SenderName = PiciEnvironment.GetGame().GetClientManager().GetNameById(SenderId);
            this.ReportedName = PiciEnvironment.GetGame().GetClientManager().GetNameById(ReportedId);
            this.ModName = PiciEnvironment.GetGame().GetClientManager().GetNameById(ModeratorId);
        }
