...
namespace Pici.Core
{
    public static class Logging
    {
        ...
        {
            SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.StandardException, tokenID++);
        ...
        {
            SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.FatalException, tokenID++);
        ...
        //{
        //    SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.DDOSException, tokenID++);
        //    Writer.LogDDOS("TokenID: " + tokenID + logText);
        //}

        internal static void LogThreadException(string Exception, string Threadname)
        {
            SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.ThreadedException, tokenID++);
        ...
        {
            SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.SQLException, tokenID++);
        ...
        {
            SessionManagement.BroadcastExceptionNotification(Pici.Core.ExceptionType.UserException, tokenID++);
