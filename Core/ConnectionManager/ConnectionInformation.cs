...
using Pici.Core.Helpers;
using SharedPacketLib;
using System.IO;
using System.Text;
using System.Diagnostics;
using Pici.Core.ConnectionManager.Messages;
using Pici.Core.ConnnectionManager.LoggingSystem;
        ...
        internal void disconnect()
        {
            try
            {
                if (isConnected)
                {
                    ...
                    Out.writeLine("[CONN MANAGER] >> Connection [" + this.connectionID + "] has been disconnected", Out.logFlags.BelowStandardlogLevel);
                    try
                    {
